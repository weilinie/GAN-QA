...
"""
import sys
workspace_path = '/home/jack/Documents/QA_QG/'
...
######### start training
trainIters(encoder1, encoder2, attn_decoder1, embeddings_index, word2index, data_tokens, max_length,
            path_to_loss_f, path_to_sample_out_f, path_to_exp_out,
            50000, print_every=200, plot_every = 10)
